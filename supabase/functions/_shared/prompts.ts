...
export function promptDigest(item: { title: string; author?: string | null }, esTexto: boolean,
  ...
  return [
    ...
    '  "mentions":[{"name":"person, outlet or institution the speaker CITES AS A SOURCE of information",',
    '               "kind":"persona|medio|institucion|obra","for":"what they are cited for, briefly"}],',
    '  "skip": false',
    '}',
    '',
    'Reglas:',
    ...
    '- `mentions` es SOLO para citas de procedencia: de dónde dice el hablante que sacó',
    '  la información ("as Hudson showed", "the FT reported", "a Treasury dataset").',
    '  Nombrar a alguien para atacarlo o de pasada NO es una mención. Máximo 5;',
    '  una lista vacía es una respuesta correcta y frecuente.',
