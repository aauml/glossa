...
<Callback issue="N.º 33" slug="eu-nist-crosswalk" lang="es">Donde el crosswalk UE–NIST se agota trazó los límites técnicos del mapeo entre el AI Act y el marco del NIST. Esta pieza examina el límite político — la posición oficial americana según la cual el mapeo no debería ser siquiera un objetivo.</Callback>
