...
<Callback issue="N° 20b" slug="wolff-third-option" lang="en">The previous issue traced a related question: if the American unipolar order is ending, is the only successor another empire — or something genuinely different? Hudson's answer here is grimmer: the successor may simply be the wreckage.</Callback>
