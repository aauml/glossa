...
<Timeline
  events={[
    { year: "feb. 2025", label: "Confirmado como noveno director del FBI" },
    { year: "jul. 2025", label: "Wellington: pistolas impresas en 3D entregadas a cargos neozelandeses; destruidas después conforme a la ley local" },
    { year: "ago. 2025", label: "Driscoll, Jensen y Evans son despedidos sumariamente" },
    { year: "sept. 2025", label: "Demanda por despido improcedente presentada en el tribunal federal de Washington" },
    { year: "feb. 2026", label: "Milán: celebración con cervezas en el vestuario del equipo USA de hockey; Trump expresa su descontento" },
    { year: "mar. 2026", label: "Desaparece una botella en Quantico; amenazas de polígrafo" },
    { year: "abr. 2026", label: "The Atlantic publica el primer reportaje de Fitzpatrick; Patel presenta una demanda por difamación de 250 millones" },
    { year: "may. 2026", label: "The Atlantic publica la continuación sobre la botella de bourbon; el FBI investigaría las filtraciones" },
  ]}
/>
