...
<Standfirst>Fitzpatrick obtained one of Patel's bottles. The engraving is the story.</Standfirst>
...
<Standfirst>The bottles are not an anomaly. They fit a pattern that predates Patel's confirmation and has continued, unbroken, into his tenure.</Standfirst>
...
<Standfirst>The bottles also have a second life — as instruments of internal control. The Quantico story is the most telling moment in the piece.</Standfirst>
...
<Timeline
  events={[
    { year: "Feb 2025", label: "Confirmed as 9th director" },
    { year: "Jul 2025", label: "Wellington: NZ pistol gifts" },
    { year: "Aug 2025", label: "Driscoll, Jensen, Evans fired; suit follows" },
    { year: "Feb 2026", label: "Milan locker-room scene" },
    { year: "Mar 2026", label: "Quantico bottle disappears" },
    { year: "May 2026", label: "Bourbon piece; defamation suit pending" },
  ]}
  label="Timeline"
