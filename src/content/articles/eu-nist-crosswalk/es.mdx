...
<Callback issue="N.º 32" slug="pattern-contestability-gap" lang="es">El N.º 32 usó PATTERN como ejemplo trabajado de esta brecha dentro de una herramienta federal concreta. Esta lectura es el marco en el que ese caso encaja: qué promete el crosswalk en general y dónde se detiene.</Callback>
