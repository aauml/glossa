...
resources:
  ...
  email:
    ...
    notes: boletín semanal y correos de confirmación/baja. Dominio ademas.ai verificado;
           la lista vive en glossa_subscribers con alta en dos pasos
    implemented_in: scripts/boletin_from_supabase.mjs
  secrets:
    provider: 1Password
